...
public class EarthquakeCityMap extends PApplet {
	...
	private void addKey() {
		...
		fill(200, 200, 200);
		// left to right, from top to bottom,bottom right, top center, from top
		// to bottm
		triangle(50, 245, 65, 245, 60, 260);

		text("City quake ", 75, 250);
	...
	private boolean isLand(PointFeature earthquake) {
		...
		// since the only variable passed is earthquake and isInCountry takes
		// two values
		// make a loop through the countryMarkers list
	...
	private void printQuakes() {
		...
		System.out.println(count + " quakes");
